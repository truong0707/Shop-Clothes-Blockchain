...
export default function Register() {
  ...
  const userRegister = useSelector(
    (state: StateStoreRegis) => state.userRegister
  );
    ...
    <div className="all regrister" style={{ marginTop: '70px' }}>
      ...
      <div className="container d-flex flex-column justify-content-center align-items-center login-center">
        ...
        >
          ...
          {errors.sex === '' || errors.sex === undefined ? (
            <p style={{ margin: '0', height: '0px' }}></p>
          ) : (
            <p
              style={{
          ...
          {errors.nationality === '' || errors.nationality === undefined ? (
            <p style={{ margin: '30px', height: '0px' }}></p>
          ) : (
            <p
              style={{
                color: '#D93025',
          ...
          <TextField
            ...
            fullWidth
          />
          {errors.comfirmPass === '' || errors.comfirmPass === undefined ? (
            <p style={{ margin: '0', height: '30px' }}></p>
          ) : (
            <p
              style={{
